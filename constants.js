...
// CHARACTER RARITY
const characters5Star = ['Diluc', 'Klee', 'Keqing', 'Jean', 'Venti', 'Xiao', 'Tartaglia', 'Mona', 'Qiqi', 'Ganyu', 'Kamisato Ayaka', 'Zhongli', 'Albedo'];
const characters4Star = ['Fischl', 'Beidou', 'Lisa', 'Razor', 'Amber', 'Xiangling', 'Bennett', 'Xinyan', 'Xingqiu', 'Barbara', 'Diona', 'Chongyun', 'Kaeya', 'Ningguang', 'Noelle', 'Sucrose']
...
const weapons5Star = [
    ...
    `Kunwu's Iris Rift`, 'Primordial Jade Winged Spear', 'Skyward Spine', 'Vortex Vanquisher',
...
const weapons3Star = [
    ...
    'Bloodtainted Greatsword', 'Debate Club', 'Ferrous Shadow', 'Quartz', 'Skyrider Greatsword', 'White Iron Greatsword', 
